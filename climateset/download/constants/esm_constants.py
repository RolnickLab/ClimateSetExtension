...
# distinction not necessary for the mother as we are first just providing data not designing the loader yet, and a
# lookup table to check where to downloda what from anyway
